...
export default function SubmissionManagement() {
  ...
  const [formData, setFormData] = useState({
    ...
    keywords: "", authors: [], volume: "", issue: "", issueLabel: "", doi: "",
  });
                  ...
                  <div className="max-w-2xl space-y-6">
                    <div className="p-7 bg-slate-50 border border-slate-200 rounded-3xl">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="md:col-span-2">
                          <label className="block text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">DOI (Zenodo)</label>
                          <input
                            type="text"
                            value={formData.doi}
                          ...
                          />
                          <p className="text-[10px] text-slate-400 mt-1.5 ml-1">Paste the DOI after manually registering this paper on Zenodo</p>
                        </div>
